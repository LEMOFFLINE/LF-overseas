...
const collections = [
  ...
  },
  {
    ...
    name: "Team & Staff Apparel",
    shortName: "Team & Staff",
    description: "Track jackets, trousers, hoodies, softshells and polos for staff, education, team and branded apparel programs.",
    intro: "Colour blocking, decoration placement, size mix and repeat-order practicality are reviewed together before samples are developed.",
    factors: ["Team identity and colour blocking", "Decoration method and placement", "Size mix and grading", "Fabric hand feel and care"],
  },
];
